...
class VeryBadScreen extends StatelessWidget {
  const VeryBadScreen({super.key});
...
class EmojiePainter extends CustomPainter{
  ...
  void paint(Canvas canvas, Size size) {
    ...
    //eyes
    final eyePaint = Paint()..color = Colors.red..strokeWidth=14;
    ...
    ;
    canvas.drawArc(Rect.fromCircle(center: Offset(center.dx, center.dy*1.5), radius: radius*.5), pi,pi, true, actionPaint);
